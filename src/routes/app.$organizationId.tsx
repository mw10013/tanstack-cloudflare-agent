          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton
                  isActive={Boolean(
                    matchRoute({ to: "/app/$organizationId/effect" }),
                  )}
                  render={
                    <Link
                      to="/app/$organizationId/effect"
                      params={{ organizationId: organization.id }}
                    >
                      Effect
                    </Link>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton
                  isActive={Boolean(
                    matchRoute({ to: "/app/$organizationId/d1" }),
                  )}
                  render={
                    <Link
                      to="/app/$organizationId/d1"
                      params={{ organizationId: organization.id }}
                    >
                      D1
                    </Link>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton
                  isActive={Boolean(
                    matchRoute({ to: "/app/$organizationId/repository" }),
                  )}
                  render={
                    <Link
                      to="/app/$organizationId/repository"
                      params={{ organizationId: organization.id }}
                    >
                      Repository
                    </Link>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton
                  isActive={Boolean(
                    matchRoute({ to: "/app/$organizationId/stripe" }),
                  )}
                  render={
                    <Link
                      to="/app/$organizationId/stripe"
                      params={{ organizationId: organization.id }}
                    >
                      Stripe
                    </Link>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton
                  isActive={Boolean(
                    matchRoute({ to: "/app/$organizationId/auth" }),
                  )}
                  render={
                    <Link
                      to="/app/$organizationId/auth"
                      params={{ organizationId: organization.id }}
                    >
                      Auth
                    </Link>
