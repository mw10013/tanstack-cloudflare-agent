/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b7c7df049a9cbea807dc7dc72c965325)
// Runtime types generated with workerd@1.20260131.0 2025-09-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "OrganizationAgent";
	}
	interface ProductionEnv {
		...
		ORGANIZATION_AGENT: DurableObjectNamespace<import("./src/worker").OrganizationAgent>;
		OrganizationWorkflow: Workflow<Parameters<import("./src/worker").OrganizationWorkflow['run']>[0]['payload']>;
		OrganizationImageClassificationWorkflow: Workflow<Parameters<import("./src/worker").OrganizationImageClassificationWorkflow['run']>[0]['payload']>;
	}
	interface Env {
		PORT: string;
		BETTER_AUTH_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DEMO_MODE" | "TRANSACTIONAL_EMAIL" | "CF_ACCOUNT_ID" | "AI_GATEWAY_ID" | "R2_BUCKET_NAME" | "R2_S3_ACCESS_KEY_ID" | "R2_S3_SECRET_ACCESS_KEY" | "PORT" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "ANALYTICS_TOKEN" | "EMAIL_WHITELIST" | "WORKERS_AI_API_TOKEN" | "AI_GATEWAY_TOKEN" | "GOOGLE_AI_STUDIO_API_KEY" | "GOOGLE_OAUTH_CLIENT_ID" | "GOOGLE_OAUTH_CLIENT_SECRET" | "GOOGLE_OAUTH_REDIRECT_URI">> {}
}
