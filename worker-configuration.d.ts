/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: be0a75064de268d367f8e92531b306a3)
// Runtime types generated with workerd@1.20260120.0 2025-09-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "UserAgent";
	}
	interface ProductionEnv {
		...
		USER_AGENT: DurableObjectNamespace<import("./src/worker").UserAgent>;
	}
	interface Env {
		PORT: string;
		BETTER_AUTH_URL: string;
